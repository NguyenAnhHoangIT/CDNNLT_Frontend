    ...
    return (
        <header id="header">
            ...
            <div className="header-right">
                ...
                <button
                    className={`header-btn${isFirstPerson ? ' active' : ''}`}
                    title="Góc nhìn thứ nhất (Đi dạo)"
                    disabled={!isHouseLoaded}
                    onClick={onFirstPersonMode}
                >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <circle cx="12" cy="12" r="3" />
                        <path d="M2 12c3.5-5 8-7 10-7s6.5 2 10 7c-3.5 5-8 7-10 7s-6.5-2-10-7z" />
                    </svg>
                    <span>Góc nhìn 1</span>
                </button>
                <button
